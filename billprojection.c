//In this project i have implemented "Linked List" to proferm various task.
#include<stdio.h>
#include<stdlib.h>
#include<string.h>
    ...
    while(1)
    {
        ...
        switch (opt)
        {
            ...
            case 2:
                ...
                printf("\n\t\t\t\t\t\t\tEnter serial no. of the food items: ");
                int num,flag = 0;
                char name[50];
                float price;
                scanf("%d",&num);
                ...
                while(temp!=NULL)
                {
                    if(temp->data==num)
                    {
                        printf("\n\t\t\t\t\t\tFood items with given serial number already exist!!\n\n");
                        flag = 1;
                        break;
                    }
                    temp = temp->next;
